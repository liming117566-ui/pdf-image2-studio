...
const upstreamBase = String(process.env.API_BASE_URL || '').replace(/\/$/, '');
const upstreamModel = String(process.env.API_MODEL || 'image2');
const upstreamKey = String(process.env.API_KEY || '');
...
if (!upstreamBase) throw new Error('API_BASE_URL is required');
